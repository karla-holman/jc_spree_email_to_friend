Deface::Override.new(
  ...
  text: '<p class="email_to_friend mobile-center"><%= link_to Spree.t(:send_to_friend, scope: :email_to_friend), email_to_friend_path("product", @product), class: "btn btn-info" %></p>',
